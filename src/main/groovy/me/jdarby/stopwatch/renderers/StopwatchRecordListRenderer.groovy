...
/**
 * Created by jdarby on 5/28/15.
 */
class StopwatchRecordListRenderer extends RendererSupport<List<?>> {

    @Override
    public void render(Context ctx, List<?> stopwatchRecordList) throws Exception {
        List<Map> stopwatchRecordListMap = stopwatchRecordList.collect { StopwatchRecord stopwatchRecord ->
